...
<body>
    ...
    <div id="a">
        ...
        <div id="c">
            ...
            <!-- <form class="tab" method="POST" action="php/login_process.php">
                ...
                <input type="submit" value="Entrar" href='artista.php'>
                <a href="register.html">Criar uma nova conta</a>
            </form> -->

            <form class="tab" action="php/login_process.php" method="POST">
    <label id="abcd" for="username">Username/Email:</label><br>
    <input type="text" id="username" name="username"><br>
    <label id="abcd" for="password">Password:</label><br>
